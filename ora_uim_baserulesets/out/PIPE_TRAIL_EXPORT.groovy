...
int trailType = (int) ruleParameters[1];

String content = pipe.getName();

if (ruleParameters[2] instanceof OutputStream && !fileFormat.equals("default") && trailType!=-1) {
//Add content as per the requirement
    OutputStream os = (OutputStream) ruleParameters[2];
    try {
...
else if(trailType==-1 || fileFormat.equals("default")){
