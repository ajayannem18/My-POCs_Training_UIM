...
public interface IpSubnetSampleApiService {
      Response processSubnet(IpSubnetSampleType body,String id,String task,String fields,Integer depth,String expand,SecurityContext securityContext)
      ;
}
