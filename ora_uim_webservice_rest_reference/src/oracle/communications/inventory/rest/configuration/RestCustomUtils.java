 ...
 */
public class RestCustomUtils extends RestBaseUtils {
    ...
    public String getCustomBaseURL(){
        ...
        try {
            ...
            return requestURL.getProtocol() + "://" + requestURL.getHost() + port + "/ReferenceRestUIM";
        } catch (MalformedURLException e) {
            return null;
        }
    }
    
    public String getCustomBaseUri(){
    	String baseUri = "/customInventoryManagement/v4";
    	return baseUri;
    }
